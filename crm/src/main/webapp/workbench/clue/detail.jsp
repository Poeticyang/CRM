...
<script type="text/javascript">
	...
	$(function(){
        ...
        //为关联市场活动模态窗口中的搜索框绑定事件，通过触发回车键来查询并展现所需的市场活动列表
        ...
        $("#bundBtn").click(function () {
            ...
            //1条或者多条
                ...
                ///workbench/clue/bund.do?cid=yyy&aid=xxx&aid=xxx&aid=xxx...
                var param = "cid=${c.id}&"
                ...
                $.ajax({
                    ...
                    success : function (data) {
                        ...
                        if (data.success){
                            ...
                            //刷新关联的市场活动列表
                            showActivityList();
                            //清除搜索框中的内容 复选框的√清掉 清空activitySearchBody中的内容

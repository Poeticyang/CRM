...
<%@ page import="com.yang.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.yang.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
    ...
    */
    function changeStage(stage,i) {
        ...
        $.ajax({
            ...
            data : {
                "id":"${t.id}",
                "stage":stage,
                "money":"${t.money}", //生成交易历史使用到
                "expectedDate":"${t.expectedDate}",//生成交易历史使用到
            },
            type : "post",
            dataType : "json",
            success : function (data) {
    ...
    function changeIcon(stage,index1) {
        ...
        //如果当前阶段的可能性为0，第一种情况，前七个一定是黑圈，后两个一个是红叉，一个是黑叉
        ...
        //如果当前阶段的可能性不为0，第二种情况，前七个有绿色标记，绿圈，黑圈，后两个一定是黑叉
        }else{
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
        ...
        <%
            ...
            //判断当前阶段
            //如果当前阶段的可能性为0  为第一种情况： 前7个一定是黑圈 后两个一个是红叉，一个是黑叉
        ...
        <%
            ...
            //如果当前阶段的可能性不为0  为第二种情况： 前7个有绿圈，绿色标记，黑圈，后两个一定是黑叉
            }else{
        ...
        <%
                    ...
                    //如果遍历出来的阶段的可能性不为0，说明是前七个，绿圈，绿色标记，黑圈
                    } else {

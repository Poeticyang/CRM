...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
    ...
    <script>
        ...
        $(function () {
            ...
            //为阶段下拉框绑定选中（改变）下拉框的事件，根据选中的阶段填写可能性
...
<body>
	...
	<form class="form-horizontal" action="workbench/transaction/save.do" id="tranForm" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" name="activityId" value="0ee0888f38a346549be66af70af09c89"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
                ...
                <input type="hidden" name="contactsId" value="6b67751f259b41f0a2c47242c3ec54f4"/>
			</div>
		</div>
